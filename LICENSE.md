Minecraft Closed-Source License
Based on MMPLv2, but has a more closed-source definition.
============================
...
The User may not modify the contents of the Mod.

4. Right to examine
--------

The User may not examine the code without the Author's permission.
The User may not examine the source files of the Mod.
...
The User may not "fork" the Codebase.  
The User may not compile the Codebase.  
The User may submit suggestions or code binaries to the Author for inclusion in the Mod.  
...
The User may not create Derivative(s) based on the Mod.  
A Derivative may not be allowed unless, the Author allows the User to create one.
